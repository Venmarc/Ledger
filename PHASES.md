...
|---|---|---|
| 24/08/2026 | PAGE_SPECS.md, PHASES.md, NOTES.md, lib/export/csv.ts, lib/export/summary.ts, app/api/export/transactions/route.ts, app/api/export/summary/route.ts, components/settings/export-section.tsx, app/(app)/settings/page.tsx, app/sw.ts | P4-CSV: Settings → Export Data — downloads transactions (by inclusive date range) and monthly income/expense/net summaries as UTF-8 RFC-4180 CSVs via authenticated GET route handlers; pure csv/summary helpers; SW NetworkOnly for /api/export/. |
